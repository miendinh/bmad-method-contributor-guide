...
> Quick reference một trang cho BMad-METHOD. In-friendly. Dán cạnh monitor.

---

## 🏛️ 3 khái niệm cốt lõi

| | Skill | Agent | Module |
|---|-------|-------|--------|
| **Là gì** | Đơn vị việc | Persona có menu | Gói skills+agents |
| **File** | SKILL.md | customize.toml | module.yaml |
| **Ví dụ** | bmad-create-prd | Mary 📊 | core, bmm |
...
Mỗi phase sinh artifacts → input cho phase sau.

## 📂 Project structure (sau install)
...
- Scalars → override
- Arrays → append
- Array of tables với `code` field → merge by code
...
8-level validation gate before marking task complete:
1. Tests EXIST
2. Tests PASS 100%
...
Big decision cần multiple views? → bmad-party-mode
