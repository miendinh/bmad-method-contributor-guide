...
> **Phase 3 - Solutioning:** Critical transition from Planning (what) to Implementation (how). Architecture + Epics/Stories + Project Context + Readiness check.
...
**Simple menu** (2 items) — Winston primarily creates architecture and checks readiness. Epics/stories and project context are usually invoked by PM John.

### Key insight
Winston's principle "**trade-offs, not verdicts**" drives the entire facilitation approach:
- Do not impose a single technology choice
- Present options with pros/cons
- User decides with Winston's input
...
Initial content only has the heading. Sections are appended per step:
...
### Goal
Transform PRD requirements + Architecture decisions into comprehensive stories organized by **USER VALUE**, creating detailed actionable stories with complete acceptance criteria for the Developer agent.
...
**Document discovery:**
- Search PRD: `{planning_artifacts}/*prd*.md` or `*prd*/index.md`
...
**Check for existing:**
- Look for `{project_knowledge}/project-context.md` or `{project-root}/**/project-context.md`
...
**Read next:** [09d-skills-phase4-deep.md](09d-skills-phase4-deep.md) — Phase 4 Implementation skills (the most complex phase).
